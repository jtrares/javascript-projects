...
/*Exercise #3:Construct a for loop that sorts the array [2, 3, 13, 18, -5, 38, -10, 11, 0, 104] into 
two new arrays:
...
for (i = 0; i < arrNum.length; i++) {
  if (arrNum[i] % 2 === 0) {
    arrNumEven.push(arrNum[i])
  }
  else {
    arrNumOdd.push(arrNum[i])
  }
}
console.log(arrNumEven);
console.log(arrNumOdd)
